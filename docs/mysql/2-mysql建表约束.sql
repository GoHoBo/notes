...
insert into jbys values(1,'张三','123');
insert into jbys values(2,'张三','123');
insert into jbys values(1,'李四','123');


insert into jbys values(NULL,'李四','123');
...
ERROR 1452 (23000): Cannot add or update a child row: a foreign key constraint fails (`test`.`students`, 
